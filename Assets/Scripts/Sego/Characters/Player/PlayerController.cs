...
public class PlayerController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        playerMechanicsProvider.Fall(playerSettings.centerDistance, playerSettings.movementAnimSpeed, playerSettings.heavyFallMoveDuration, playerSettings.isGround);
