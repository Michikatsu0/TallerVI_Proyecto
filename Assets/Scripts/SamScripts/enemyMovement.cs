...
using UnityEngine;
/// <summary>
/// Script for automated movement for the enemies, uses dotween
/// you can choose what you like
/// duration, final position, if it moves, ease, looptype, how many loops
/// </summary>

public class enemyMovement : MonoBehaviour
{
    //here change the duration of the movement, the lesser the duration the higher the speed
